...
namespace RockWeb.Blocks.Engagement.SignUp
{
    ...
    public partial class SignUpDetail : RockBlock
    {
        ...
        private void BuildEditModeAttributesControls( Group group )
        {
            ...
            // Purposefully using a new, unmanaged RockContext instance here, due to the unpredictable
            // need for lazy loading of these entities' props with respect to ViewState, Etc.
