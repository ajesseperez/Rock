...
namespace Rock.Plugin.HotFixes
{
    ...
    public class AddInteractionIntent : Migration
    {
        ...
        {
            JPH_AddInteractionIntents_Down();
        }

        /// <summary>
        /// JPH: Add Interaction Intent defined type and defined values up.
        /// </summary>
        private void JPH_AddInteractionIntents_Up()
        {
...
WHERE [Guid] = '{Rock.SystemGuid.DefinedType.INTERACTION_INTENT}';" );
        ...
        /// JPH: Add Interaction Intent defined type and defined values up.
        /// </summary>
        private void JPH_AddInteractionIntents_Down()
        {
